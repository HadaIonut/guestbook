...
var or__45909__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj52159 = {"detail":data};
return obj52159;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__45897__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__45897__auto__)){
var and__45897__auto____$1 = (window["CustomEvent"]);
...
var f = (function (){var pred__52166 = cljs.core._EQ_;
var expr__52167 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__52166.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__52167))){
return ((function (pred__52166,expr__52167){
return (function (p1__52160_SHARP_){
return console.warn(p1__52160_SHARP_);
});
;})(pred__52166,expr__52167))
} else {
if(cljs.core.truth_(pred__52166.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__52167))){
return ((function (pred__52166,expr__52167){
return (function (p1__52161_SHARP_){
return console.debug(p1__52161_SHARP_);
});
;})(pred__52166,expr__52167))
} else {
if(cljs.core.truth_(pred__52166.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__52167))){
return ((function (pred__52166,expr__52167){
return (function (p1__52162_SHARP_){
return console.error(p1__52162_SHARP_);
});
;})(pred__52166,expr__52167))
} else {
return ((function (pred__52166,expr__52167){
return (function (p1__52163_SHARP_){
return console.log(p1__52163_SHARP_);
});
;})(pred__52166,expr__52167))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__52170){
...
var opts = map__52171__$1;
var eval_fn = cljs.core.get.call(null,map__52171__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__52173_SHARP_){
return new_def.callback(p1__52173_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__52175,(0),null);
var v = cljs.core.nth.call(null,vec__52175,(1),null);
...
if(cljs.core.truth_((function (){var and__45897__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1499848594634