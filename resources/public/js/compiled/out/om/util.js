...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(om.util.force_children),G__30030);
} else {
return G__30030;
}
});
om.util.union_QMARK_ = (function om$util$union_QMARK_(expr){
var expr__$1 = (function (){var G__30031 = expr;
if(cljs.core.seq_QMARK_(expr)){
return cljs.core.first(G__30031);
} else {
return G__30031;
}
})();
...
if(cljs.core.seq_QMARK_(expr)){
var G__30032 = cljs.core.first(expr);
return (om.util.join_key.cljs$core$IFn$_invoke$arity$1 ? om.util.join_key.cljs$core$IFn$_invoke$arity$1(G__30032) : om.util.join_key.call(null,G__30032));
} else {
return expr;
...
var expr__$1 = (function (){var G__30033 = expr;
if(cljs.core.seq_QMARK_(expr)){
return cljs.core.first(G__30033);
} else {
return G__30033;
}
})();
